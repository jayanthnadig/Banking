...
namespace ASNRTech.CoreService.Utilities {
    internal static class Utility {
        ...
        internal static string InvoicePortalConnString {
            get {
                return Utility.GetConnectionString("InvoicePortal");
            }
        }

        internal static bool IsDeveloper {
            get {
                return string.Compare(Utility.CurrentUserId, "valluri", true, CultureInfo.InvariantCulture) == 0;
            }
        }
        ...
        internal static string MiicrrasConnString {
            get {
                return Utility.GetConnectionString("Miicrras");
            }
        }

        internal static string ElcsPortalConnString {
            get {
                return Utility.GetConnectionString("ELCSPortal");
            }
        }

        internal static string TLConnectConnString {
            get {
                return Utility.GetConnectionString("TLConnect");
            }
        }
